...
import com.raffleclub.app.fragment.BankAndDrawalActivity;
...
public class WalletActivity extends AppCompatActivity {
    ...
    private AlertDialog alertDialog() {
        return new AlertDialog.Builder(this)
                // Set Dialog Message
                .setTitle("WITHDRAWAL LIMIT")
                .setMessage("# Minimum withdrawal amount: "+AppConstant.CURRENCY_SIGN +""+AppConstant.MIN_WITHDRAW_LIMIT)
                // negative button
                .setNegativeButton("Close", (dialog, which) -> dialog.dismiss()).create();
    }
    private AlertDialog dialogChooseWallet() {
        return new AlertDialog.Builder(this)
                // Set Dialog Message
                .setTitle("Choose withdraw")
                .setPositiveButton("Bank Account",
                        (dialog, which) -> Function.fireIntent(context, BankAccountActivity.class))
                // negative button
                .setNegativeButton("Wallet", (dialog, which) -> {
    ...
    public void withdrawBalance() {
        try {
            if (amount < AppConstant.MIN_WITHDRAW_LIMIT) {
                ...
                Intent intent = new Intent(WalletActivity.this, BankAndDrawalActivity.class);
                intent.putExtra("curr_amount", amount);
                Function.fireIntentWithData(WalletActivity.this, intent);

//                dialogChooseWallet().show();
            }
