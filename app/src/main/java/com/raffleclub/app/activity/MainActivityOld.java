...
//        chatBt.setOnClickListener(v -> Customerly.openSupport(MainActivityOld.this));
//
...
//        });
//
//        adapter = new ViewPagerAdapter(getSupportFragmentManager(), MainActivityOld.this, viewPager, tabLayout);
...
//
//        layoutNotif = findViewById(R.id.layoutNotif);
//        layoutNotif.setOnClickListener(view -> Function.fireIntent(MainActivityOld.this, NotificationActivity.class));
//    }
//
...
//                        countNotif.setText(String.valueOf(legalData.size()));
...
//                // positive button
//                .setPositiveButton("Confirm", (dialog, which) -> Preferences.getInstance(MainActivityOld.this).setlogout())
//                // negative button
...
//                    mListener.onFinish();
//                }
//                Function.fireIntent(context, MainActivityOld.class);
//            }
//        };
//    }
//
