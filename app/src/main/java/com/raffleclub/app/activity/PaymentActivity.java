...
import com.raffleclub.app.utils.GenerateRandomString;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    public void buyTicket() {
        if (currentAmount >= payableAmount) {
            ...
            textInputError.setText("You don't have enough deposit amount balance to buy this Ticket, please add balance to your Wallet and then try to buy the Ticket again.");
        }
    }

    private void addTicket() {
        progressBarHelper.showProgressDialog();
        Call<CustomerModel> call = api.addTicket(AppConstant.PURCHASE_KEY,
                ...
                Preferences.getInstance(context).getString(Preferences.KEY_CONTST_ID),
                feedId,
                entryFees,
                ticketNoTv.getText().toString()
        );
    ...
    private void getUserWallet() {
        ...
        Call<CustomerModel> call = api.getUserWallet(
