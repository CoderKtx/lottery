...
public class ApiConstant {
    public static final String REGISTRATION_USER_WITH_REFER = "user_register";
    public static final String REGISTRATION_USER_WITHOUT_REFER = "user_register";
    ...
    public static final String GET_USER_WALLET = "user_wallet";
