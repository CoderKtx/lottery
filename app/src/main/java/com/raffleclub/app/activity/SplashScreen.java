...
import com.raffleclub.app.BuildConfig;
...
public class SplashScreen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("testDOB", "onCreate: "+
                Preferences.getInstance(this).getString(Preferences.KEY_DOB));
        ...
        if(Function.checkNetworkConnection(SplashScreen.this)) {
            ...
            statusTv.setText("Ohh! No internet Connection, please try again.");
        }
...
//                Log.i("testApiDet", "onResponse: "+response.isSuccessful());
//                Log.i("testApiDet", "onResponse: "+response.body().getResult().get(0).getSuccess());
//                Log.i("testApiDet", "onResponse: "+response.body().getResult().get(0).getMop());
                        ...
                        if (res.get(0).getSuccess() == 1) {
                            ...
                            try {
                                if (BuildConfig.VERSION_CODE < Integer.parseInt(latestVersionCode)) {
                                    ...
                                    statusTv.setText("RaffleClub is under maintenance, please try again later.");
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
